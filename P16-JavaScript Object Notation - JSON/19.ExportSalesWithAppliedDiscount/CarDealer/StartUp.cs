namespace CarDealer
{
    ...
    public class StartUp
    {
        public static void Main()
        {
            ...
            //File.WriteAllText(@"../../../Results/CarsWithTheirListOfParts17.json", output);

            //18
            //string output = GetTotalSalesByCustomer(context);
            //File.WriteAllText(@"../../../Results/TotalSalesByCustomer18.json", output);

            //19
            string output = GetSalesWithAppliedDiscount(context);
            File.WriteAllText(@"../../../Results/SalesWithAppliedDiscount19.json", output);
        }
        ...
        {
            var orderedCarAndParts = context.Cars
                .Select(c => new
                {
                    car = new
                    {
            ...
            return JsonConvert.SerializeObject(orderedCarAndParts, Formatting.Indented);
        }
